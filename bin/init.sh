...
cm="${cm:-$cfd}"
yes="${NPM_INIT_YES}"
name="${NPM_INIT_NAME:-${PWD##*/}}"
version="${NPM_INIT_VERSION:-0.0.0}"
description="${NPM_INIT_DESCRIPTION}"
main="${NPM_INIT_MAIN:-index.js}"
scripts_test="${NPM_INIT_SCRIPTS_TEST:-exit}"
repository="${NPM_INIT_REPOSITORY}"
keywords="${NPM_INIT_KEYWORDS}"
author="${NPM_INIT_AUTHOR}"
license="${NPM_INIT_LICENSE:-MIT}"
